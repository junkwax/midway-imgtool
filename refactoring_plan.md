...
Branch: `refactor/overlay-split` (93 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is at 20,204 lines; `ui_canvas.cpp` is now 3,085
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      selection, and paste hover/sprite hit-testing,
