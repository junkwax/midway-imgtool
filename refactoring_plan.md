...
Branch: `refactor/overlay-split` (62 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 19,171 lines; `ui_canvas.cpp` is now 1,598
...
marked-lane panel layout/header controls, per-lane edit controls, thumbnail strip, drag handling, sprite/tag/status drawing, and
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      strip, and sprite panel layout/header controls/drag handling, tag/status
