...
Branch: `refactor/overlay-split` (86 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 20,263 lines; `ui_canvas.cpp` is now 2,859
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      overlay),
      paste/free-transform geometry helpers incl. proportional resize and
      rotate math,
