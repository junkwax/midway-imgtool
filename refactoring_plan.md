...
Branch: `refactor/overlay-split` (82 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 20,410 lines; `ui_canvas.cpp` is now 2,621
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      overlay drawing), paste/free-transform geometry helpers,
