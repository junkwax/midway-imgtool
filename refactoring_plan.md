...
Branch: `refactor/overlay-split` (77 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 20,509 lines; `ui_canvas.cpp` is now 2,388
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      anipoint hit-testing/overlay drawing, IMG hitbox and MK2 strike-box overlay drawing, DMA compression and
