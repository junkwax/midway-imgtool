...
Branch: `refactor/overlay-split` (88 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 20,218 lines; `ui_canvas.cpp` is now 3,007
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      math, opaque content bounds, and paste snap/center-guide math,
