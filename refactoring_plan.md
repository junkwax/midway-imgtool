...
Branch: `refactor/overlay-split` (85 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 20,271 lines; `ui_canvas.cpp` is now 2,840
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      overlay),
      paste/free-transform geometry helpers incl. proportional resize math,
