...
Branch: `refactor/overlay-split` (96 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is at 20,175 lines; `ui_canvas.cpp` is now 3,208
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      selection, paste hover/sprite hit-testing, paste drag resolution, and
      transform drag resolution, and paste preview-cell geometry,
