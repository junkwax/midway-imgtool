...
Branch: `refactor/overlay-split` (94 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is at 20,188 lines; `ui_canvas.cpp` is now 3,135
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      selection, paste hover/sprite hit-testing, and paste drag resolution,
