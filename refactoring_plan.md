...
Branch: `refactor/overlay-split` (95 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is at 20,180 lines; `ui_canvas.cpp` is now 3,181
