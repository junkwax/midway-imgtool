...
Branch: `refactor/overlay-split` (92 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is at 20,205 lines; `ui_canvas.cpp` is now 3,072
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      snap/center-guide math, paste clamp geometry, and paste hint-state
      selection,
