...
Branch: `refactor/overlay-split` (80 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 20,465 lines; `ui_canvas.cpp` is now 2,485
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      pencil cursor drawing, clone-stamp visual aids),
