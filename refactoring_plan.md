...
Branch: `refactor/overlay-split` (61 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 19,238 lines; `ui_canvas.cpp` is now 1,508
...
marked-lane panel layout, per-lane edit controls, thumbnail strip, drag handling, sprite/tag/status drawing, and
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      strip, and sprite panel layout/drag handling, tag/status drawing, render rect bookkeeping,
