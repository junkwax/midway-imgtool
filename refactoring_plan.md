...
Branch: `refactor/overlay-split` (87 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 20,249 lines; `ui_canvas.cpp` is now 2,892
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      math and opaque content bounds,
