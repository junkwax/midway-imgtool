...
Branch: `refactor/overlay-split` (75 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 20,537 lines; `ui_canvas.cpp` is now 2,315
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      anipoint crosshair drawing, IMG hitbox and MK2 strike-box overlay drawing, DMA compression and
