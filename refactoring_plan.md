...
Branch: `refactor/overlay-split` (83 commits ahead of `SDL-main`). Working tree
clean. `imgui_overlay.cpp` is down to 20,404 lines; `ui_canvas.cpp` is now 2,667
...
- [ ] `ui_canvas` — canvas render, pan/zoom, World View. **Started:** the
      ...
      overlay drawing, paste border/snap-guide/hint chrome),
      paste/free-transform geometry helpers,
